...
Thats not really hard but it can get really funny.
...
Then we could use BSearch to search through the contact_book making the search a lot faster.
...
Therefore a LSearch with normal adding would be better.
...
In this case, and since is a contact_book, which you usually use to search for phones and sometimes add new phones, then we re gonna use Bsearch and sort algorithm.
